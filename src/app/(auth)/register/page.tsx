...
export default function Register() {
  ...
  const { control ,handleSubmit }= useForm<zod.infer<typeof schema>>({
    defaultValues:{
        "name": "",
    "email":"",
    "password":"",
  ...
  async function submitForm(data:zod.infer<typeof schema>){
    // call api
      ...
      <div className="flex items-center justify-center bg-gray-50 px-6 py-12 lg:bg-white">
        <div className="w-full max-w-md">
          ...
          <p className="mb-8 text-center text-sm text-gray-500">
            Sign up to use your fresh shopping experience
          </p>
